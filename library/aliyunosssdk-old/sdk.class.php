...
//加载conf.inc.php文件
require_once OSS_API_PATH.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'config.php';//conf.inc.php';
...
//加载MimeTypes
require_once OSS_API_PATH.DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR.'mimetypes.class.php';

//检测语言包
if(file_exists(OSS_API_PATH.DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR.ALI_LANG.'.inc.php')){
	require_once OSS_API_PATH.DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR.ALI_LANG.'.inc.php';
}else{
...
class ALIOSS{
	...
	public function upload_file_by_file($bucket, $object, $file, $options = NULL){
		...
		$options[self::OSS_BUCKET] = $bucket;
		$options[self::OSS_OBJECT] = $object;
		$options[self::OSS_CONTENT_TYPE] =isset($options[self::OSS_CONTENT_TYPE])?$options[self::OSS_CONTENT_TYPE]:$content_type;
