...
{
    include_once dirname(__FILE__) .DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'wall'.DIRECTORY_SEPARATOR.'biaoqing.php';
...
function user_register() 
{
    ...
    if ($flagconfig['reserved_infomation_verify']==1) {
        ...
        if ($qiandaoshenhe==2) {
            $newuserinfo=$load->flag_model->getUserinfo($openid, false, true);
