		...
		<div class="container">
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="#" target="_blank">关于我们</a> &nbsp; &nbsp; <a href="http://www.deeja.top/" target="_blank">帮助</a> &nbsp; &nbsp; <a href="#" target="_blank">源码论坛</a>
				</div>
				<div class="text-center">
					Powered by <a href="#" target="_blank"><b>微信上墙大屏幕互动系统</b></a>  &copy; 2019 
				</div>
			</div>
		</div>
    ...
    echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014-2015，人人现场互动团队保留所有权利。 </h3>
				<p>
...
function Tpl_Install_finish()
{
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“微信现场活动系统”系统，您现在可以: <br />
