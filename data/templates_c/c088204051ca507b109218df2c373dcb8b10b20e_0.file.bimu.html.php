<?php
/* Smarty version 3.1.33, created on 2024-06-14 20:36:18
  from '/www/wwwroot/interaction/myadmin/templates/bimu.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_666c394204f0c1_70390421',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c088204051ca507b109218df2c373dcb8b10b20e' => 
    array (
      0 => '/www/wwwroot/interaction/myadmin/templates/bimu.html',
      1 => 1557210574,
      2 => 'file',
    ),
  ),
...
function content_666c394204f0c1_70390421 (Smarty_Internal_Template $_smarty_tpl) {
		...
		<h3 class="header smaller lighter blue">
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-6">
					<!-- PAGE CONTENT BEGINS -->
						<form class="form-horizontal" method="post" action="dobimu.php?action=setimage" role="form" enctype="multipart/form-data">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">显示方式</label>
							<div class="col-sm-9">
								<div class="radio-inline">
		 								<label>
											<input name="fullscreen" type="radio" class="ace" value="1" <?php if ($_smarty_tpl->tpl_vars['bimu_config']->value['fullscreen'] == 1) {?>checked<?php }?> />
											<span class="lbl">居中</span>
										</label>
									</div>
									<div class="radio-inline">
										<label>
											<input name="fullscreen" type="radio" class="ace" value="2" <?php if ($_smarty_tpl->tpl_vars['bimu_config']->value['fullscreen'] == 2) {?>checked<?php }?> />
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" >闭幕图：</label>
							<div class="col-sm-9">
							...
							<span class="col-sm-12 alert-info well">大屏幕长宽比一致即可(宽度最大不超过1200px，高度最大不超过1000px)，不要超过500kb<br/>
								<a href="/wall/themes/meepo/assets/images/bimu.png" target="_blank">点此去下载原图</a></span>
								</div>
							</div>
...
jQuery(function($){
	$('input[name=fullscreen]').bind('click',function(){
		...
		$.ajax({
			"url":"dobimu.php?action=setfullscreen",
	...
	<?php if ($_smarty_tpl->tpl_vars['bimu_config']->value['image'] != '') {?>
	
	$('input[name=imagepath]')
	.ace_file_input('show_file_list', [
		{type: 'image', name: '背景图', path: '<?php echo $_smarty_tpl->tpl_vars['bimu_config']->value['image'];?>
'},
	]);
