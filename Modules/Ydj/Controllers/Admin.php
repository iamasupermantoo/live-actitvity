...
function _uploadfile($file,$allowtypes='image/jpg,image/jpeg,image/png,image/gif')
{
    ...
    public function ajax_act_save_config()
    {
        ...
        // $config['status']=isset($_POST['status'])?intval($_POST['status']):1;
        $config['showstyle']
            = isset($_POST['showstyle'])?intval($_POST['showstyle']):1;
        $config['themeid']=1;//isset($_POST['themeid'])?intval($_POST['themeid']):1;
        // $config['themeid']=isset($_POST['themeid'])?intval($_POST['themeid']):1;
