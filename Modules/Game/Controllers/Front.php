...
require_once BASEPATH . DIRECTORY_SEPARATOR . "wall" . DIRECTORY_SEPARATOR . "biaoqing.php";
...
class Front extends Frontbase
{
    ...
    private function getTopTen()
    {
        ...
        for($i=0,$l=count($topusers);$i<$l;$i++){
            ...
            $data[]=['avatar'=>$topusers[$i]['avatar'],'nickname'=>$topusers[$i]['nickname'],'point'=>$topusers[$i]['point']];
        }
        return $data;
    }
